...
class ProfileTestClass(TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.test_profile = Profile(name = 'regine' , usertype = '1' ,email = 'patient@gmail.com',phone_number ='0712567583', hospital = 'Tenwek' ,location = 'Bomet')
...
class AppointmentTestClass(TestCase):
    ...
    def setUp(self):
        ...
        Method that runs at the begining of each Test case
        '''
        self.test_profile = Appointment(type_of_appointment = 'Consultation',appointment_date = '05/02/2019', appointment_time = '7:00')
